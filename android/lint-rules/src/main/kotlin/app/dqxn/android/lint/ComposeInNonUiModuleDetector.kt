 ...
 *
 * Non-UI modules: sdk.contracts, sdk.common, sdk.observability, sdk.analytics,
 * core.thermal, core.firebase, core.agentic, data.
 *
 * Exception: sdk.contracts may use @Composable, @Immutable, @Stable from
 * compose.runtime via compileOnly -- these specific imports are allowed.
 */
class ComposeInNonUiModuleDetector : Detector(), SourceCodeScanner {
    ...
    companion object {
         ...
         */
        private val ALLOWED_CONTRACTS_IMPORTS = setOf(
         ...
         */
        private val NON_UI_PACKAGES = listOf(
        ...
        val ISSUE: Issue = Issue.create(
            ...
            explanation = "This module does not have the Compose compiler enabled. " +
