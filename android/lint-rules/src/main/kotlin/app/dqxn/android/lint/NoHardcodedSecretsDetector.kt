 ...
 *
 * Secrets should be stored in local.properties, environment variables, or a secrets management
 * solution -- never in source code.
 */
class NoHardcodedSecretsDetector : Detector(), SourceCodeScanner {
  ...
  companion object {
    private val SUSPICIOUS_NAME_PATTERN =
      Regex(
    ...
    val ISSUE: Issue =
      Issue.create(
        ...
        explanation =
          "API keys, tokens, and credentials must not be hardcoded in source. " +
