 ...
 *
 * Pack modules can only depend on :sdk:* and :pack:*:snapshots.
 * They must never import from :feature:*, :core:*, or :data.
 */
class ModuleBoundaryViolationDetector : Detector(), SourceCodeScanner {
    ...
    companion object {
        /**
         * Checks if the file's package indicates it lives in a pack module.
         * Pack modules use the package pattern: app.dqxn.android.pack.*
         * Snapshot sub-modules (app.dqxn.android.pack.*.snapshots) are also pack code.
         */
        ...
        val ISSUE: Issue = Issue.create(
            ...
            explanation = "Pack modules (:pack:*) can only depend on :sdk:* and :pack:*:snapshots. " +
