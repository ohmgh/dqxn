 ...
 *
 * All calls go through [AnalyticsTracker.track] which gates on consent internally
 * via [AnalyticsTracker.isEnabled]. No additional consent checks needed at call sites.
 */
...
/**
 * Tracks an upsell impression event. [trigger] identifies what surface triggered the upsell
 * (see [UpsellTrigger] constants). [packId] identifies the pack being upsold.
 */
...
/**
 * Well-known trigger sources for upsell impressions (F12.6).
 * New trigger sources should be added here as constants rather than inlined as strings.
 */
