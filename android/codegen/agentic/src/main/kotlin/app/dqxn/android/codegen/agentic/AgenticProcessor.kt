...
class AgenticProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        for (classDecl in annotatedSymbols) {
            ...
            val annotation = classDecl.annotations.first { annotation ->
                annotation.annotationType.resolve().declaration
                    .qualifiedName?.asString() == AGENTIC_COMMAND_FQN
            }
            ...
            val category = annotation.arguments
    ...
    private fun implementsCommandHandler(classDecl: KSClassDeclaration): Boolean =
        classDecl.superTypes.any { superTypeRef ->
            superTypeRef.resolve().declaration
                .qualifiedName?.asString() == COMMAND_HANDLER_FQN
        }
