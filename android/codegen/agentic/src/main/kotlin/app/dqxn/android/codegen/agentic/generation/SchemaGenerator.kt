...
internal class SchemaGenerator(
    ...
    fun generate(commands: List<CommandInfo>) {
        val entryType = TypeSpec.classBuilder(ENTRY_NAME)
            ...
            .addProperty(
                PropertySpec.builder("category", String::class)
        ...
        val commandsInitializer = CodeBlock.builder()
            .add("listOf(\n")
            .indent()
        ...
        val commandsProperty = PropertySpec.builder(
            "commands",
