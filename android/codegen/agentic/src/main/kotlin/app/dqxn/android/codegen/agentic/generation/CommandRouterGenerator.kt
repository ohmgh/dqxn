...
internal class CommandRouterGenerator(
    ...
    fun generate(commands: List<CommandInfo>) {
        val moduleBuilder = TypeSpec.interfaceBuilder(MODULE_NAME)
        ...
        val fileSpec = FileSpec.builder(GENERATED_PACKAGE, MODULE_NAME)
    ...
    private companion object {
        ...
        val DAGGER_SINGLETON_COMPONENT =
            ClassName("dagger.hilt.components", "SingletonComponent")
        val COMMAND_HANDLER =
            ClassName("app.dqxn.android.core.agentic", "CommandHandler")
    }
}
