...
/**
 * Debug-only ContentProvider transport for the agentic diagnostic framework. Dispatches ADB
 ...
 *
 * Registered only in `src/debug/AndroidManifest.xml` (NF21 -- zero agentic code in release APK).
 */
