...
autonomous: true
requirements: [F13.5, F13.9, NF21, NF22]
...
<task type="auto">
  ...
  <action>
    ...
    **NF22 verification:** Confirm `BuildConfig.DEMO_MODE_AVAILABLE` is `false` in release build by checking the generated `BuildConfig.java` in `app/build/generated/source/buildConfig/release/`.
  </action>
  <verify>
