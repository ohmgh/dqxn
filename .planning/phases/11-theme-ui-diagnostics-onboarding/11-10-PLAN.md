...
files_modified:
  - android/feature/settings/src/main/kotlin/app/dqxn/android/feature/settings/theme/AnalyticsEventCallSites.kt
  - android/feature/settings/src/test/kotlin/app/dqxn/android/feature/settings/theme/AnalyticsEventCallSiteTest.kt
  - android/feature/onboarding/src/main/kotlin/app/dqxn/android/feature/onboarding/SessionLifecycleTracker.kt
  - android/feature/onboarding/src/test/kotlin/app/dqxn/android/feature/onboarding/SessionLifecycleTrackerTest.kt
autonomous: true
requirements:
  - F12.2
  - F12.3
...
must_haves:
  ...
  artifacts:
    - path: "android/feature/settings/src/main/kotlin/app/dqxn/android/feature/settings/theme/AnalyticsEventCallSites.kt"
      provides: "Helper functions for firing analytics events at interaction points"
    - path: "android/feature/settings/src/test/kotlin/app/dqxn/android/feature/settings/theme/AnalyticsEventCallSiteTest.kt"
      provides: "Tests verifying event parameter completeness and consent gating"
    - path: "android/feature/onboarding/src/main/kotlin/app/dqxn/android/feature/onboarding/SessionLifecycleTracker.kt"
      provides: "Session start/end event firing with quality metrics"
    - path: "android/feature/onboarding/src/test/kotlin/app/dqxn/android/feature/onboarding/SessionLifecycleTrackerTest.kt"
...
<task type="auto">
  ...
  <action>
    ...
    4. `events not fired when tracker disabled` — set tracker to disabled (via mock), call helpers, verify track NOT called (note: this verifies the gating is internal to tracker, not in helpers)
  ...
  <verify>
    <automated>cd /Users/ohm/Workspace/dqxn/android && ./gradlew :feature:settings:testDebugUnitTest --tests "*.AnalyticsEventCallSiteTest" --console=plain 2>&1 | tail -20</automated>
  </verify>
...
<task type="auto">
  ...
  <verify>
    <automated>cd /Users/ohm/Workspace/dqxn/android && ./gradlew :feature:onboarding:testDebugUnitTest --tests "*.SessionLifecycleTrackerTest" --console=plain 2>&1 | tail -20</automated>
  </verify>
...
<verification>
cd /Users/ohm/Workspace/dqxn/android && ./gradlew :feature:settings:testDebugUnitTest --tests "*.AnalyticsEventCallSiteTest" :feature:onboarding:testDebugUnitTest --tests "*.SessionLifecycleTrackerTest" --console=plain
</verification>
